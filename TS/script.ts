...
restaurants.push(
  new Restaurant(
    ...
    "./img/Thai_Restaurant.png",
    "+43(1)5812308",
    "Thai",
    "www.thai-restaurant.com"
  )
);
...
restaurants.push(
  new Restaurant(
    ...
    "./img/SIXTA_Restaurant.png",
    "+43 1 58 528 56",
    "Austrian",
    "https://www.sixta-restaurant.at/index.htm#start"
  )
);
...
events.push(
  new Events(
    ...
    "./img/EVENT_Kris_Kristofferson.jpeg",
    "Fr, 15.11.2021",
    "20:00",
    58.5,
...
let locationDiv: HTMLElement | null = document.getElementById("locationsTable");
if (locationDiv) {
...
let restaurantDiv: HTMLElement | null =
  document.getElementById("restaurantsTable");
if (restaurantDiv) {
...
let eventsDiv: HTMLElement | null = document.getElementById("eventsTable");
if (eventsDiv) {
